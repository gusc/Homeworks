...
fileprivate let ColHeaders = ["No.", "Goalkeeper", "Team", "Goals", "", "", "", "", ""]

class TopGoalkeeperView : DataView
{
    var data:[TopGoalkeeperRow]?
    
    init(_ withData:[TopGoalkeeperRow])
    {
        data = withData
    }
